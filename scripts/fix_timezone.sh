...
# Este script ejecuta el SQL directamente en el contenedor de Docker

echo "Aplicando corrección de zona horaria a la base de datos..."

# Ejecutar el SQL en el contenedor de Docker
docker exec -i docker-smartpay-db-v12-1 psql -U postgres -d smartpay < scripts/fix_datetime.sql
